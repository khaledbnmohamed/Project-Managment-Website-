        ...
        <form method = "post" action = "{{route('projects.store') }}">
            {{ csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="string" class="form-control" name='name' id="comapny-name" aria-describedby="emailHelp" placeholder="Enter project name" >
                    ...
                    @if ($companies != null)
                      <div class="form-group">
                      <label for="company-content">Select Compnay</label>
