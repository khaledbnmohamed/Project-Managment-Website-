            ...
            {{-- //work around to post --}}
                  <input type ="hidden" name= "_method" value = "put"> 
                    <div class="form-group">
                        ...
                        <input type="string" class="form-control" name='name' id="comapny-name" aria-describedby="emailHelp" placeholder="Enter project name" required value="{{$project->name}}">
...
<html lang="en">
  ...
  <body>
            ...
            <div class="sidebar-module">
              ...
              <li><a href="/projects/{{$project->id}}">View Companies</a></li>
              <li><a href="/projects/">All Companies</a></li>
